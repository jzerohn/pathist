class ArmorClass:
    ...
    def __init__ (self, armor_bonus = 0, shield_bonus = 0, dexterity_modifier = 0, enhancement_bonus = 0, deflection_bonus = 0, natural_armor = 0, dodge_bonus = 0, size_bonus = 0, other = 0):
        if armor_bonus < 0 or shield_bonus < 0 or enhancement_bonus < 0 or deflection_bonus < 0 or natural_armor < 0 or dodge_bonus < 0 or other < 0:
            raise ValueError('bonus from armor must be at least zero')
    ...
    def update_armor(self, armor_bonus = 0, shield_bonus = 0, dexterity_modifier = 0, enhancement_bonus = 0, deflection_bonus = 0, natural_armor = 0, dodge_bonus = 0, size_bonus = 0, other = 0):
        ...
        self._flat_footed = 10 + armor_bonus + min(0, dexterity_modifier) + shield_bonus + enhancement_bonus + deflection_bonus + natural_armor + dodge_bonus + size_bonus + other
